 <aside class="left-sidebar">
    ...
    <div><img src="<?php echo base_url();?>assets/images/users/2.jpg" alt="user-img" class="img-circle"></div>
                        <div class="dropdown">
                            <a href="javascript:void(0)" class="dropdown-toggle u-dropdown link hide-menu" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php // echo $user_name;?> <span class="caret"></span></a>
                            <div class="dropdown-menu animated flipInY">
                                ...
                                <div class="dropdown-divider"></div>
                                <!-- text-->
                                <a href="javascript:void(0)" class="dropdown-item" data-toggle="modal" data-target="#myModal"><i class="ti-unlock"></i> Change Password</a>
                                <div class="dropdown-divider"></div>
                                <!-- text-->
                                <a href="<?php base_url() ?>logout" class="dropdown-item"><i class="fa fa-power-off"></i> Logout</a>
                                <!-- text-->                                
                            </div>
                        </div>
                    </div>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Jobs <span class="badge badge-pill badge-cyan ml-auto">4</span></span></a>
                <ul aria-expanded="false" class="collapse">

<li><a href="<?php echo base_url();?>user/create_meeting">Create Meeting </a></li>
                                <li><a href="<?php echo base_url();?>user/viewjobs">View Jobs</a></li>
                                <li><a href="<?php echo base_url();?>user/table">Table</a></li>
                            </ul>
                        </li>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn waves-effect waves-light btn-info" data-dismiss="modal" style="    margin-right: 215px;">Close</button>
          <button type="submit" class="btn waves-effect waves-light btn-info">Change Password</button>
        </div>
    </form>
        </div>
      </div>
