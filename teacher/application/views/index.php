...
<body class="skin-default card-no-border">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Teacher Login</p>
        </div>
    </div>
    <!-- ============================================================== -->
    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url('http://www.retail-associates.com/wp-content/uploads/2016/10/website-login-background.jpg');">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" method="POST" action="<?php echo base_url();?>user/login">
                        <h3 class="box-title m-b-20">Teacher Login</h3>
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" type="text" required="" placeholder="Username" name="name"> </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
