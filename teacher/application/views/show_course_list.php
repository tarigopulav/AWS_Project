            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All Courses<a href="<?php base_url()?>add_course" style="float:right"><img style="height:50px;widht:50px" src="<?php echo base_url()?>assets/glypicon-plus.png"></a></h4>
