        ...
        <table class="table display compact cell-border"  id="maintable" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr> 
                    ...
                    <td>
                        <?php if($get_student['attendance_status'] == 0){?>
                         <p><span style="border-radius: 20rem;color:white" class="badge badge-danger">Proxy</span></p>
                         <?php }?>
                        <?php if($get_student['attendance_status'] == 1){?>
                        <p><span style="color:white;border-radius: 20rem;" class="badge badge-success">Valid</span></p>
                        <?php }?>
                        </td>
