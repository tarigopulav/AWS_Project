                                ...
                                <div class="col-sm-12 col-xs-12">
                                     <form method="POST" action="<?php echo base_url();?>user/insert_ip" enctype='multipart/form-data'>
                                        <div class="form-group">
                                            <label for="exampleInputuname">User ip_name</label>
                                            <div class="input-group">
                                                
                                               <input type="text" name="ip_name" data-style="form-control" class="form-control" required=""> </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">IP -ADDRESS</label>
                                            <div class="input-group">
                                                
                                                 <input type="text" name="ip_apddress" data-style="form-control" class="form-control" required=""> </div>
                                        </div>
