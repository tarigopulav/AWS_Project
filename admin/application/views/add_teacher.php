            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add Teacher</h4> </div>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                     <form method="POST" action="<?php echo base_url();?>user/submit_add_teacher" enctype='multipart/form-data'>
                                        <div class="form-body">
                                    ...
                                    <option value="Female">Female</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" name="fileToUpload" id="fileToUpload" accept=".jpeg, .jpg, .gif,.png" required></div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                       ...
                                       <?php foreach($all_subject as $subject_data){?>
